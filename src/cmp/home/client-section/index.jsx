                ...
                <div className="carousel-wrap layout_padding2-top ">
                    ...
                    <div className="item">
                        ...
                        <div className="client_id">
                            ...
                            <img src="images/client-1.jpg" alt="client-section-img"/>
                            </div>
                    ...
                    <div className="item">
                        ...
                        <div className="client_id">
                            <div className="img-box">
                            <img src="images/client-2.jpg" alt="client-section-img2"/>
                            </div>
                            <div className="client_detail">
                            <div className="client_info">
                                <h6>
                    ...
                    <div className="item">
                        ...
                        <div className="client_id">
                            <div className="img-box">
                            <img src="images/client-1.jpg" alt="client-section-img3"/>
                            </div>
                            <div className="client_detail">
                            <div className="client_info">
                                <h6>
                    ...
                    <div className="item">
                        ...
                        <div className="client_id">
                            <div className="img-box">
                            <img src="images/client-2.jpg" alt="client-section-img4"/>
                            </div>
                            <div className="client_detail">
                            <div className="client_info">
                                <h6>
